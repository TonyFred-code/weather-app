export default function WeatherSummary() {
  return (
    <section className="lg:col-span-2 space-y-8">
      <div className="bg-blue-500 rounded-2xl bg-[url('/images/bg-today-small.svg')] md:bg-[url('/images/bg-today-large.svg')] bg-no-repeat bg-cover  md:bg-cover bg-center px-8 py-12 flex flex-col md:flex-row">
        ...
        <div className="flex items-center justify-around">
          ...
          <span className="text-[90px] font-extrabold italic">20°</span>
        </div>
      </div>
